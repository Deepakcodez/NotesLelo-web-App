        ...
        <div className="w-full flex flex-col">
            ...
            <div className="mb-2">
                ...
                <div className="flex rounded-md shadow-sm ring-1 ring-inset focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 ">
                    <input
                        className={cn("block flex-1 border-0 text-white  py-1.5 pl-1 bg-gray-700/25 rounded-md placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6", className)}
                        {...props}
                    />
                </div>
            </div>
