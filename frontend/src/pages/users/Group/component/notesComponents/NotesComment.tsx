...
const NotesComment: React.FC<CommentSidebarProps> = ({ isOpen, toggleSidebar, postId, post }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="md:bg-slate-700/20 bg-slate-800/60 h-[70%] w-full flex flex-col justify-between  pb-6 rounded-lg shadow-xl overflow-hidden border border-slate-200/10  ">
